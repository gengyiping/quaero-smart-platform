...
<<<<<<< HEAD
			...
			<view style="margin-top: 10rpx;">缺料日期：{{content.uzzql}}</view>
			<view style="margin-top: 10rpx;">交付模式：{{content.upmczd}}</view>
			<view style="margin-top: 10rpx;">缺料数量：{{content.upmcQty}}</view>
			<view style="margin-top: 10rpx;">单据类型：{{content.ymessage}}</view>
			<view style="margin-top: 10rpx;">订单号：{{content.ubaseEntry}}</view>
			<view style="margin-top: 10rpx;">订单行号：{{content.ubaseLine}}</view>
			<view style="margin-top: 10rpx;">订单版本：{{content.ymessage}}</view>
			<view style="margin-top: 10rpx;">预交日期：{{content.ushipDate}}</view>
			<view style="margin-top: 10rpx;">未交数量：{{content.ujyjfqty}}</view>
			<view style="margin-top: 10rpx;">PMC需求版本：{{content.ymessage}}</view>
			<view style="margin-top: 10rpx;">仓位：{{content.ymessage}}</view>
		</view>
...
<<<<<<< HEAD
			Confirmbutton: function() {
				...
				for(var i=0;i<that.lists.length;i++){
					...
					that.listitem.push(that.arrayitem)
					console.info("路径",that.listitem)	
				}
				console.info("上传的图片",that.lists)
...
<<<<<<< HEAD
				...
				uni.getStorage({
					...
					success: function(res) {
						...
						that.header.Authorization = res.data
						console.log("获取缓存中的是:", that.header.Authorization);
					}
				});
			},
=======
